...
<br/><br/>
 <br/><br/>
    <div class="wrapper mt-5 ml-5 mr-5 pr-3">
        <h1 class="text-warning"> Mot du president </h1>


        <img class="mt-3 d-block img-fluid w-25 pr-3  float-left"  src="/img/A2.jpeg">

        <p><h3 class=""><b >Mr ...</b></h3><br/>
        ...
        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry'
            ...
            The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here,
             content here', making it look like readable English. Many desktop publishing packages and web page editors now use. </p>
      </div>
